...
write.table(table1.1, file=paste0(path, "demuth_table1.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(table2.1, file=paste0(path, "demuth_table2.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(table3.1, file=paste0(path, "demuth_table3.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(table1.2, file=paste0(path, "french_table1.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(table2.2, file=paste0(path, "french_table2.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(table3.2, file=paste0(path, "french_table3.txt"), row.names = FALSE, col.names = TRUE)
