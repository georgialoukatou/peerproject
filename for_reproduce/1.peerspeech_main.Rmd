...
keychildren <- c("Neuoe") # "Litlhare", "Neuoe" Hlobohang #cCHANGE KEYCHILD NAME
for (sp in speakers){
  for (child in keychildren){
    for (sess in sessionsNeuoe){ ####CHANGE SESSION NAME
...
for (sp in speakers){
  for (child in keychildren){
    for (sess in sessionsTheotime){   ####CHANGE SESSION NAME
