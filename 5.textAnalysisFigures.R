...
demuthlongstats<-read.csv(file="/Users/admin/Desktop/resultspeerspeech/shortoutputSesotho.csv", header=TRUE)
demuthlongstats$language<-"Sesotho"
demuthlongstats<-demuthlongstats[!is.na(demuthlongstats$numberoflines), ]

frenchlongstats<-read.csv(file="/Users/admin/Desktop/resultspeerspeech/shortoutputFrench.csv", header=TRUE) 
...
write.table(speechelicitation, file=paste0("/Users/admin/Desktop/resultspeerspeech/speechelicitation.txt"), row.names = FALSE, col.names = TRUE)
write.table(acrossspeechelic, file=paste0("/Users/admin/Desktop/resultspeerspeech/speechelicitation_short.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(lexicaldiv, file=paste0("/Users/admin/Desktop/resultspeerspeech/lexicaldiversity.txt"), row.names = FALSE, col.names = TRUE)
write.table(acrosslexicaldiv, file=paste0("/Users/admin/Desktop/resultspeerspeech/lexicaldiversity_hapax_short.txt"), row.names = FALSE, col.names = TRUE)
...
png(filename="/Users/admin/Desktop/resultspeerspeech/mlu_new1.png", width = 13, height = 4, units = 'in', res = 500)
...
png(filename="/Users/admin/Desktop/resultspeerspeech/ttr_new.png",  width = 13, height = 4, units = 'in', res = 500)
...
png(filename="/Users/admin/Desktop/resultspeerspeech/questionratio_new.png",  width = 13, height = 4, units = 'in', res = 500)
...
png(filename="/Users/admin/Desktop/resultspeerspeech/singlewordutt_new.png",  width = 13, height = 4, units = 'in', res = 500)
...
png(filename="/Users/admin/Desktop/resultspeerspeech/convturn_new.png",  width = 13, height = 4, units = 'in', res = 500)
...
png(filename="/Users/admin/Desktop/resultspeerspeech/hapax_new.png",  width = 13, height = 4, units = 'in', res = 500)
