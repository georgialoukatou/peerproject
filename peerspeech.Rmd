...
wells_ADSCDS<- ggplot(wells_fig, aes( y=as.numeric(nb_utt), x=input, fill=speaker))+
  geom_bar(stat="identity", position="dodge") +  labs(x="Wells Corpus", y="Number of utterances") + scale_fill_discrete(labels= c("Adults", "Mother", "Peers", "Siblings")) + guides(fill=guide_legend(title=NULL))
