...
sum(wells_siblings$no_rows)/total_winput *100 #35.10517 %
...
sum(wells_chi$no_rows)/total_winput *100 #3.52473 %
...
sum(wells_adu$no_rows)/total_winput *100  #6.495168 %
...
write.table(wells_ad_directed_utts, file=paste0(lang, "Wellsadultdirected.txt"), row.names=F, col.names=T,  quote=F) 
 ...
 # n of child-directed utterances
length(wells_ad_directed_utts$UTTERANCE)/ length(wells_annotated_input$UTTERANCE) * 100 #100
