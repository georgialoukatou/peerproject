...
kchprop_french <- ggplot(fr_speaker_prop, aes( y=prop_utt, x=keychild, fill=speaker))+geom_bar(stat="identity", position="fill")+  labs(x="Keychild", y="Number of utterances")
kchprop_demuth <- ggplot(d_speaker_prop, aes( y=prop_utt, x=keychild, fill=speaker))+geom_bar(stat="identity", position="fill")+  labs(x="Keychild", y="Number of utterances")+ guides(fill=FALSE)
...
kchprop_french <- ggplot(fr_speaker_prop_clean, aes( y=prop_utt, x=keychild, fill=speaker))+geom_bar(stat="identity", position="fill")+  labs(x="Keychild", y="Number of utterances")
kchprop_demuth <- ggplot(d_speaker_prop_clean, aes( y=prop_utt, x=keychild, fill=speaker))+geom_bar(stat="identity", position="fill")+  labs(x="Keychild", y="Number of utterances")+ guides(fill=FALSE)
...
```{r error bars}
#for error bars
simpled_tot <- tot_sum_demuth_register[, c(2, 3,4)]
simplef_tot <- tot_sum_french_register[, c(2, 4)]

simpled <- tot_sum_demuth_register[, c(1, 3)]
simplef<- tot_sum_french_register[, c(1, 3)]
