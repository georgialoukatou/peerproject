...
sesotho="/Users/admin/Documents/peerspeech_03.06.2020/demuth.txt"
french="/Users/admin/Documents/peerspeech_03.06.2020/french.txt"
...
sed -e "s/\"//g" -e 's/\n//g'  "${path_}demuthturns.txt"> "${path_}demuthturns1.txt"  && mv "${path_}demuthturns1.txt" "${path_}demuthturns.txt"
