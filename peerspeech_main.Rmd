...
demuth<-read.csv(file="/Users/admin/Downloads/sesotho_sessions.csv", header=TRUE) # memory processing problems, can't load googlesheets
...
#save changes
write.table(demuth, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/demuth_input_1.txt"), row.names=F, col.names=T,  quote=F) 
...
write.table(sum_demuth, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/demuth_speakers.txt"), row.names=F, col.names=T,  quote=F) 
...
#####TABLE1-SESOTHO
write.table(wide_table1, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/demuth_table1.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(demuth_ad_directed_utts, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/Sesothoadultdirected.txt"), row.names=F, col.names=T,  quote=F) 
write.table(demuth_oc_directed_utts, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/Sesothootherchilddirected.txt"), row.names=F, col.names=T,  quote=F) 
write.table(demuth_c_directed_utts, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/Sesothochilddirected.txt"), row.names=F, col.names=T,  quote=F) 
...
#####TABLE2-SESOTHO
write.table(wide_table2, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/demuth_table2.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(merged_speaker_info_demuth, file=paste0("/Users/admin/Documents/peerspeech_13.06.2020/demuth.txt"), row.names = FALSE, col.names = TRUE, sep=";;")
