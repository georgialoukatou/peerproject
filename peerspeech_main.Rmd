...
#save changes
write.table(demuth, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/demuth_input_1.txt"), row.names=F, col.names=T,  quote=F) 

#Sum the number of utterances per speaker category and keychild
aggregate(demuth$utterance_id,by=list( demuth$speaker, demuth$keychild, demuth$session_id),length )->sum_demuth
colnames(sum_demuth) <- c("speaker", "keychild", "session", "nb_utt")
write.table(sum_demuth, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/demuth_speakers.txt"), row.names=F, col.names=T,  quote=F) 
...
#####TABLE1-SESOTHO
write.table(wide_table1, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/demuth_table1.txt"), row.names = FALSE, col.names = TRUE)
...
nrow(demuth) #38565
aggregate(demuth$utterance_id,by=list(demuth$annotation1,  demuth$speaker, demuth$keychild,  demuth$session_id),FUN=length )->sum_demuth_addressee
...
aggregate(merged_speaker_info_demuth$utterance_id,by=list(merged_speaker_info_demuth$register, merged_speaker_info_demuth$keychild, merged_speaker_info_demuth$session_id),FUN=length )->sum_demuth_register
...
write.table(demuth_ad_directed_utts, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/Sesothoadultdirected.txt"), row.names=F, col.names=T,  quote=F) 
write.table(demuth_oc_directed_utts, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/Sesothootherchilddirected.txt"), row.names=F, col.names=T,  quote=F) 
write.table(demuth_c_directed_utts, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/Sesothochilddirected.txt"), row.names=F, col.names=T,  quote=F) 
...
#####TABLE2-SESOTHO
write.table(wide_table2, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/demuth_table2.txt"), row.names = FALSE, col.names = TRUE)

aggregate(merged_speaker_info_demuth$utterance_id,by=list(merged_speaker_info_demuth$register, merged_speaker_info_demuth$speaker, merged_speaker_info_demuth$keychild, merged_speaker_info_demuth$session_id),FUN=length )->sum_demuth_register_speakers
...
#####TABLE2.2-SESOTHO
write.table(table2.2, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/demuth_table2.2.txt"), row.names = FALSE, col.names = TRUE)
...
write.table(merged_speaker_info_demuth, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/demuth.txt"), row.names = FALSE, col.names = TRUE)
...
# "Litlhare", "Tsebo" Hlobohang
speakers <- c("mother", "child", "adult")
sessions<- as.vector(unique(demuth$session_id))
sessionsHlobohang<-sessions[1:45]
sessionsLitlhare<-sessions[46:90]
sessionsTsebo<-sessions[91:129]

#Save for corpus analysis
for (sp in speakers){
  for (child in keychildren){
    for (sess in sessionsLitlhare){
    demuth_keychild_directed_sp_child_sess<-demuth_keychild_directed[(demuth_keychild_directed$speaker==sp) & ( demuth_keychild_directed$keychild==child)& ( demuth_keychild_directed$session_id==sess), ]
    write.table(demuth_keychild_directed_sp_child_sess, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/utterances/Sesotho/", child, sp, sess, "CDS.csv"), row.names=F, col.names=T, sep="\t",  quote=F) 
  }
 }
}
...
for (sp in speakers){
  for (child in keychildren){
    for (sess in sessionsLitlhare){
      demuth_otherchild_directed_sp_child_sess<-  demuth_otherchild_directed[(demuth_otherchild_directed$speaker==sp) & ( demuth_otherchild_directed$keychild==child)& ( demuth_otherchild_directed$session_id==sess), ]
      write.table(demuth_otherchild_directed_sp_child_sess, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/utterances/Sesotho/", child, sp, sess, "OCDS.csv"), row.names=F, col.names=T, sep="\t",  quote=F) 
    }
  }
}
...
for (sp in speakers){
  for (child in keychildren){
    for (sess in sessionsLitlhare){
      demuth_adult_directed_sp_child_sess<-  demuth_adult_directed[(demuth_adult_directed$speaker==sp) & ( demuth_adult_directed$keychild==child)& ( demuth_adult_directed$session_id==sess), ]
      write.table(demuth_adult_directed_sp_child_sess, file=paste0("/Users/admin/Documents/peerspeech_03.06.2020/utterances/Sesotho/", child, sp, sess, "ADS.csv"), row.names=F, col.names=T, sep="\t",  quote=F) 
    }
  }
}
