 ...
 for addressee in addressees:
  for targetchild in targetchildren:
   ...
   for session_ in listFrench:
    file1=open("{}cleanutterance{}{}{}{}.csv".format(pathToTextf, targetchild, speaker, session_, addressee), 'r')
    textall=file1.readlines()
    output_file=open("{}partofspeechutterance{}{}{}{}.csv".format(pathToTextf, targetchild, speaker, session_, addressee), "w")
    for s in textall:
     s1=""
     doc=nlp(s)
     for token in doc:
